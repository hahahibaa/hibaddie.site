...
const og = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630">
  ...
  <text x="100" y="380" font-family="Segoe UI, Arial, sans-serif" font-size="36" fill="#8f8b84">Robotics, automation, mechanical.</text>
  <text x="100" y="430" font-family="Segoe UI, Arial, sans-serif" font-size="36" fill="#8f8b84">ELYT: everything can be learned from a YouTube tutorial.</text>
  <rect x="100" y="480" width="80" height="4" fill="#e0a96d"/>
  <text x="100" y="555" font-family="Segoe UI, Arial, sans-serif" font-size="30" fill="#e0a96d">hibaddie.co</text>
</svg>`;
